...
Nhiệm vụ: Hãy mở rộng câu hỏi trên thành 2 câu hỏi để tăng cường ngữ cảnh và hiểu rõ hơn ý định của người dùng.

Yêu cầu:
- Câu 1: Giữ nguyên câu hỏi gốc
- Câu 2: Tạo câu hỏi mở rộng liên quan đến thuốc, công dụng, liều lượng, tác dụng phụ, hoặc cách sử dụng
